                                        ...
                                        <h3>(Invoice{index +1}) <br/> ID:{invoice._id}</h3>
                                            ...
                                            */}
                                                ...
                                                <i> {invoice.frequency} {invoice.client} {invoice.result}s at a rate of {"$" + invoice.rate} per {invoice.result} = <b> {"$" + (invoice.rate * invoice.frequency).toFixed(2)}. </b>
                                                        ...
                                                        minus a service fee of <b>({"$" + 19.75})</b> and Tax 10% <b>({'$' + ((invoice.rate * invoice.frequency * (invoice.callumfee)).toFixed(2) && (invoice.rate * invoice.frequency * (invoice.callumfee) + invoice.rate2 * invoice.frequency2 * (invoice.callumfee)).toFixed(2))})</b>.
